...
const TOPICS = [
  { topic: 'travel', ru: 'путешествия и отпуск', target: 30 },
  { topic: 'work', ru: 'работа и офис', target: 30 },
  { topic: 'food', ru: 'еда и рестораны A2', target: 30 },
  { topic: 'health', ru: 'здоровье', target: 25 },
  { topic: 'shopping', ru: 'покупки', target: 25 },
  { topic: 'phrasal_verbs', ru: 'фразовые глаголы A2', target: 25 },
  { topic: 'feelings', ru: 'эмоции и состояния A2', target: 20 },
  { topic: 'adjectives', ru: 'описание людей и вещей A2', target: 30 },
  { topic: 'technology', ru: 'технологии и компьютеры', target: 20 },
  { topic: 'education', ru: 'обучение', target: 20 },
  { topic: 'verbs', ru: 'глаголы A2', target: 40 },
];
...
let nextRank = Math.max(0, ...existing.map((w) => w.frequencyRank ?? 0)) + 1;
const all = [...existing];
